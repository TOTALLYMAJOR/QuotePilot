...
- Operations surface candidate: exact-SHA local browser and visual evidence is
  ...
  discovered governance omissions and run `33902068474` stopped on the prior
  compatibility bundle ceiling after all unit, build, capability, and docs
  checks passed. Calm Four remains unchanged. The exact measured 1,120-byte
  ceiling correction is committed locally and has not been pushed by user
  instruction, so it has no qualifying CI evidence.
...
|---|---|---|---|
| AC-001 | AC-001 — ProposalComposer remains canonical | PENDING | No evidence recorded at contract checkpoint. |
| AC-002 | AC-002 — One form state | PENDING | No evidence recorded at contract checkpoint. |
| AC-003 | AC-003 — One pricing authority | PENDING | No evidence recorded at contract checkpoint. |
| AC-004 | AC-004 — One Menu state | PENDING | No evidence recorded at contract checkpoint. |
| AC-005 | AC-005 — One staffing model | PENDING | No evidence recorded at contract checkpoint. |
| AC-006 | AC-006 — One blocker/readiness model | PENDING | No evidence recorded at contract checkpoint. |
| AC-007 | AC-007 — One save path | PENDING | No evidence recorded at contract checkpoint. |
| AC-008 | AC-008 — Guided shares form state | PENDING | No evidence recorded at contract checkpoint. |
| AC-009 | AC-009 — One AI mutation path | PENDING | No evidence recorded at contract checkpoint. |
| AC-010 | AC-010 — New components presentation-only | PENDING | No evidence recorded at contract checkpoint. |
| AC-011 | AC-011 — Domain switching is non-mutating | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-015 | AC-015 — Guided ↔ Workbench preserves all supported unsaved state | PENDING | No evidence recorded at contract checkpoint. |
| AC-016 | AC-016 — Existing quote identity/version semantics preserved | PENDING | No evidence recorded at contract checkpoint. |
| AC-017 | AC-017 — Desktop clearly communicates Quote Plan / Living Object / Commercial Truth | PENDING | No evidence recorded at contract checkpoint. |
| AC-018 | AC-018 — One major domain active at a time | PENDING | No evidence recorded at contract checkpoint. |
| AC-019 | AC-019 — Normal screen does not expose every detailed domain simultaneously | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-022 | AC-022 — Exactly five primary composition domains unless repository evidence justifies a change | PENDING | No evidence recorded at contract checkpoint. |
| AC-023 | AC-023 — Current domain is visible without relying only on color | PENDING | No evidence recorded at contract checkpoint. |
| AC-024 | AC-024 — Domain status markers are evidence-backed | PENDING | No evidence recorded at contract checkpoint. |
| AC-025 | AC-025 — Exact blockers focus the correct domain where possible | PENDING | No evidence recorded at contract checkpoint. |
| AC-026 | AC-026 — Every domain keyboard reachable | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-033 | AC-033 — Package, Service style, Menu, Rentals and Enhancements are organized under Experience | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-047 | AC-047 — Total remains discoverable while editing any desktop domain | PENDING | No evidence recorded at contract checkpoint. |
| AC-048 | AC-048 — Deposit remains discoverable | PENDING | No evidence recorded at contract checkpoint. |
| AC-049 | AC-049 — Rail total originates from canonical totals | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-068 | AC-068 — Internal-only evidence excluded | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-071 | AC-071 — Guided uses same form state | PENDING | No evidence recorded at contract checkpoint. |
| AC-072 | AC-072 — Guided behavior retained | PENDING | No evidence recorded at contract checkpoint. |
| AC-073 | AC-073 — Supported flag-off/rollback path remains coherent if still required | PENDING | No evidence recorded at contract checkpoint. |
| AC-074 | AC-074 — No dual canonical editor | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-084 | AC-084 — Activity remains inspectable | PENDING | No evidence recorded at contract checkpoint. |
| AC-085 | AC-085 — Activity secondary while healthy | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-087 | AC-087 — 1440px workbench intentionally uses desktop hierarchy | PENDING | No evidence recorded at contract checkpoint. |
| AC-088 | AC-088 — 768px adaptation has no horizontal document overflow | PENDING | No evidence recorded at contract checkpoint. |
| AC-089 | AC-089 — 390px uses intentional mobile composition, not squeezed desktop columns | PENDING | No evidence recorded at contract checkpoint. |
| AC-090 | AC-090 — Mobile total/attention remains readily discoverable | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-101 | AC-101 — Zero new serious/critical axe violations | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-109 | AC-109 — Bundle budget passes or any exception is explicitly justified | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-114 | AC-114 — Operations menu is no longer an undifferentiated 10+ item feature inventory | PENDING | No evidence recorded at contract checkpoint. |
| AC-115 | AC-115 — Daily execution has one obvious operational entry | PENDING | No evidence recorded at contract checkpoint. |
| AC-116 | AC-116 — Calendar/Schedule is reused rather than replaced | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-119 | AC-119 — Calendar is the default operational lens when current capability supports it | PENDING | No evidence recorded at contract checkpoint. |
| AC-120 | AC-120 — Existing Month view retained | PENDING | No evidence recorded at contract checkpoint. |
| AC-121 | AC-121 — Existing Week view retained | PENDING | No evidence recorded at contract checkpoint. |
| AC-122 | AC-122 — Accepted/booked events remain correctly projected | PENDING | No evidence recorded at contract checkpoint. |
| AC-123 | AC-123 — Existing conflict detection retained | PENDING | No evidence recorded at contract checkpoint. |
| AC-124 | AC-124 — Time overlap detection retained | PENDING | No evidence recorded at contract checkpoint. |
| AC-125 | AC-125 — Unknown-time warnings retained | PENDING | No evidence recorded at contract checkpoint. |
| AC-126 | AC-126 — Capacity-conflict logic retained | PENDING | No evidence recorded at contract checkpoint. |
| AC-127 | AC-127 — Staff-lead assignment remains available under existing authority | PENDING | No evidence recorded at contract checkpoint. |
| AC-128 | AC-128 — Production checklist remains available | PENDING | No evidence recorded at contract checkpoint. |
| AC-129 | AC-129 — Existing kitchen/run-of-show planning context remains available where currently supported | PENDING | No evidence recorded at contract checkpoint. |
| AC-130 | AC-130 — Calendar does not claim live telemetry that does not exist | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-132 | AC-132 — Calendar event opens exact existing event/opportunity identity | PENDING | No evidence recorded at contract checkpoint. |
| AC-133 | AC-133 — No duplicate Event record introduced | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-154 | AC-154 — Staff private/role authority unchanged | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-172 | AC-172 — Transition introduces no duplicate persisted Event entity unless one already exists authoritatively | PENDING | No evidence recorded at contract checkpoint. |
| AC-173 | AC-173 — Planning state explicitly distinguished from live actuals | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-203 | AC-203 — Calendar golden path | PENDING | No evidence recorded at contract checkpoint. |
...
| AC-207 | AC-207 — Opportunity-to-Calendar path | PENDING | No evidence recorded at contract checkpoint. |
| AC-208 | AC-208 — Now-to-Calendar path | PENDING | No evidence recorded at contract checkpoint. |
| AC-209 | AC-209 — Calendar-to-Opportunity path | PENDING | No evidence recorded at contract checkpoint. |
| AC-210 | AC-210 — Calendar usable at 1440 | PENDING | No evidence recorded at contract checkpoint. |
| AC-211 | AC-211 — Calendar usable at 768 | PENDING | No evidence recorded at contract checkpoint. |
| AC-212 | AC-212 — Calendar usable at 390 or has an intentional mobile agenda/list adaptation | PENDING | No evidence recorded at contract checkpoint. |
| AC-213 | AC-213 — Mobile Operations preserves event date/time/context | PENDING | No evidence recorded at contract checkpoint. |
| AC-214 | AC-214 — Mobile event conflict remains understandable | PENDING | No evidence recorded at contract checkpoint. |
| AC-215 | AC-215 — No horizontal page overflow | PENDING | No evidence recorded at contract checkpoint. |
| AC-216 | AC-216 — Calendar navigation keyboard accessible | PENDING | No evidence recorded at contract checkpoint. |
| AC-217 | AC-217 — Selected day/event state accessible beyond color | PENDING | No evidence recorded at contract checkpoint. |
| AC-218 | AC-218 — Conflict state has textual meaning | PENDING | No evidence recorded at contract checkpoint. |
| AC-219 | AC-219 — Event details have semantic structure | PENDING | No evidence recorded at contract checkpoint. |
| AC-220 | AC-220 — Focus is restored after event/detail overlays where applicable | PENDING | No evidence recorded at contract checkpoint. |
| AC-221 | AC-221 — No new serious/critical axe violations | PENDING | No evidence recorded at contract checkpoint. |
| AC-222 | AC-222 — Every route intentionally removed from primary/Operations navigation remains reachable through its new intended path | PENDING | No evidence recorded at contract checkpoint. |
| AC-223 | AC-223 — Browser Back/Forward remains correct | PENDING | No evidence recorded at contract checkpoint. |
| AC-224 | AC-224 — Direct deep links remain correct | PENDING | No evidence recorded at contract checkpoint. |
| AC-225 | AC-225 — Auth/role restrictions unchanged | PENDING | No evidence recorded at contract checkpoint. |
| AC-226 | AC-226 — Mobile Workspace/tools navigation remains accessible | PENDING | No evidence recorded at contract checkpoint. |
| AC-227 | AC-227 — No route silently aliases to semantically wrong destination | PENDING | No evidence recorded at contract checkpoint. |
| AC-228 | AC-228 — Focused unit/component tests pass | PENDING | No evidence recorded at contract checkpoint. |
| AC-229 | AC-229 — Relevant pre-existing tests remain green or have evidence-backed expectation updates | PENDING | No evidence recorded at contract checkpoint. |
| AC-230 | AC-230 — Quote workbench real-route Playwright passes | PENDING | No evidence recorded at contract checkpoint. |
| AC-231 | AC-231 — Operations/Calendar real-route Playwright passes | PENDING | No evidence recorded at contract checkpoint. |
| AC-232 | AC-232 — Responsive matrix passes | PENDING | No evidence recorded at contract checkpoint. |
| AC-233 | AC-233 — Accessibility matrix passes | PENDING | No evidence recorded at contract checkpoint. |
| AC-234 | AC-234 — Build passes | PENDING | No evidence recorded at contract checkpoint. |
| AC-235 | AC-235 — Bundle/governance passes | PENDING | No evidence recorded at contract checkpoint. |
| AC-236 | AC-236 — Exact-head CI passes | PENDING | No evidence recorded at contract checkpoint. |
| AC-237 | AC-237 — Screenshots/visual evidence correspond to exact candidate SHA | PENDING | No evidence recorded at contract checkpoint. |
| AC-238 | AC-238 — Source/CI evidence is not reported as hosted/human acceptance | PENDING | No evidence recorded at contract checkpoint. |
