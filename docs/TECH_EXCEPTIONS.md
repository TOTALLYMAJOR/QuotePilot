...
- Date: August 11, 2026 (supersedes the earlier August 11 ceiling record)
...
- Change: Apply named, absolute temporary ceilings of 2,789,740 aggregate
  ...
  taking effect at the next release from this branch), together with the
  source-only owner-SMS provider panel and its fail-closed Pingram evidence
  states, are reviewed with it. The clean-main baseline remains
