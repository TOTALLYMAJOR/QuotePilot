...
- A temporary exception, when present in
  ...
  `bundle-budget.json`.
- The workspace-convergence exception (now including the flag-gated NOW home
  surface candidate) is currently capped at 2,700,437
  ...
  clean-main baseline, aggregate output is 703,072 bytes (35.20%) larger, while
