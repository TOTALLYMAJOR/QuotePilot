...
test.describe("customer-centered workspace", () => {
  ...
  test("the production pilot matrix exposes NOW, Event Room, and staged client changes", async ({ page }) => {
    ...
    await expect(page.getByRole("spinbutton", { name: /Guests \(max 400\)/i })).toHaveValue("90");
  });
