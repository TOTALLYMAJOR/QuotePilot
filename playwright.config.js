...
function buildWebServer(port, role) {
  ...
  return {
    ...
    env: {
      ...
      VITE_PILOT_EVENT_ROOM_ENABLED: process.env.VITE_PILOT_EVENT_ROOM_ENABLED ?? "false",
      VITE_AMBIENT_UI_ENABLED: process.env.VITE_AMBIENT_UI_ENABLED ?? "false",
      VITE_OPERATIONAL_STAFFING_ENABLED: process.env.VITE_OPERATIONAL_STAFFING_ENABLED ?? "false",
      VITE_PILOT_GUIDED_SELLING_ENABLED: process.env.VITE_PILOT_GUIDED_SELLING_ENABLED ?? "false",
      VITE_PILOT_CREATE_ENABLED: process.env.VITE_PILOT_CREATE_ENABLED ?? "false",
