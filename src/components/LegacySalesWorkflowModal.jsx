                        ...
                        <>
                          ...
                          <div className="workflow-attention-actions">
                            <button
                              ...
                              className="ghost compact"
                              onClick={() => handleOpenCloseoutWorkspace(quote)}
                              aria-label={`${quote.customerId && onOpenCustomer ? "Open the client overview" : "Open quote"} for post-event closeout — ${quoteLabel}`}
                            >
                              {quote.customerId && onOpenCustomer ? "Open the client overview" : "Open quote"}
                            </button>
                          </div>
                        </>
                      )}
