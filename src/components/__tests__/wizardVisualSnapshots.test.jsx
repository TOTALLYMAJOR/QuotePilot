...
describe("wizard visual snapshots", () => {
  ...
  test("step review proposal sheet snapshot", () => {
    ...
    expect(normalizeMarkup(markup)).toMatchInlineSnapshot(`"<div class="review"><article class="quote-sheet"><h2>Catering Quote</h2><div class="quote-sheet-meta"><p><strong>Quote Date:</strong> <QUOTE_DATE></p><p class="quote-sheet-meta-wide"><strong>Responsible Party / Client:</strong> Jordan Lee / Civic Foundation</p><p><strong>Phone #:</strong> 205-555-0162</p><p><strong>Email Address:</strong> jordan@example.com</p><p><strong># of Guests:</strong> 120</p><p><strong>Time of Event:</strong> <EVENT_TIME></p><p><strong>Name of Event:</strong> Summer Client Gala</p><p><strong>Date of Event:</strong> <EVENT_DATE></p><p class="quote-sheet-meta-wide"><strong>Event Location:</strong> Birmingham Civic Hall</p><p class="quote-sheet-meta-wide"><strong>Venue Address:</strong> 123 Event Way, Birmingham, AL</p><p class="quote-sheet-meta-wide"><strong>Dietary Restrictions:</strong> Shellfish allergy, no pork</p></div><section class="quote-sheet-menu"><h3>Menu</h3><p>Smoked Ribs, Garlic Mashed Potatoes</p></section><section class="quote-sheet-charges"><div class="quote-charge"><span>Per Person: $24.00 x (120)</span><strong>$2880.00</strong></div><div class="quote-charge"><span>Tax: (10%)</span><strong>$539.75</strong></div><div class="quote-charge"><span>Staffing</span><strong>$1520.00</strong></div><div class="quote-charge"><span>Travel Fee</span><strong>$16.80</strong></div><div class="quote-charge"><span>Bartender</span><strong>$300.00</strong></div><div class="quote-charge quote-charge-wide"><span>Staff Count (per hour x staff count)</span><strong>S 10 / C 3 / B 2</strong></div><div class="quote-charge"><span>Gratuity</span><strong>$1103.54</strong></div><div class="quote-charge quote-charge-wide"><span>Add-ons/Rentals/Menu</span><strong>$1414.00</strong></div></section><p class="quote-center-note"><strong>All disposables are included in this quote.</strong></p><p class="quote-total-line">TOTAL: <strong>$7774.10</strong></p><div class="quote-sheet-bottom"><p><strong>Quote prepared by:</strong> Event Sales Team</p><p><strong>Quote is valid for 30 days.</strong></p></div><p class="quote-acceptance">To accept quote, please sign and return to events@acme.test</p><p class="quote-deposit-tag"><strong>30% deposit is required to lock in your date.</strong></p><p class="quote-signoff">Gratuity is never expected but is always appreciated!</p><p class="quote-contact-strip">6230 Eagle Ridge Cir, Pinson, AL 35126 • (205) 555-0135 • events@acme.test</p></article><div class="summary-total"><p>Deposit (30%): <strong>$2332.23</strong></p></div></div>"`);
  });
});
