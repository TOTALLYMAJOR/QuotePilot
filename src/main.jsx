...
const BuyerAccessPage = lazy(() => import("./components/BuyerAccessPage"));
...
createRoot(document.getElementById("root")).render(
  <React.StrictMode>
    {isMarketingRoute ? (
      ...
      <Suspense fallback={<div className="qp-route-loading" role="status">Loading secure buyer access...</div>}>
        <BuyerAccessPage />
      </Suspense>
    ) : (
