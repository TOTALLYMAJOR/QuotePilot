...
describe("deployment-scoped tenant workflow runtime", () => {
  test.each(["EVENT_OPERATING_SPINE_ENABLED", "COMMERCIAL_CHANGE_AUTHORITY_ENABLED", "OPERATIONAL_STAFFING_AUTHORITY_ENABLED", "INVENTORY_AUTHORITY_ENABLED", "REVENUE_AUTOPILOT_ENABLED", "GOOGLE_CALENDAR_INTEGRATION_ENABLED", "INQUIRY_SHOWCASE_ENABLED"])("restricts %s to the approved tenant even when another tenant enables settings", (flag) => {
